...
public class RecyclerIntroduceMovieActorAdapter extends RecyclerView.Adapter {
    ...
    private List<MovieDetailsBean.ResultBean.MovieActorBean> datas = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        myViewHolder.tv_introduce_name.setText(datas.get(i).getName().toString());
    ...
    public void addData(List<MovieDetailsBean.ResultBean.MovieActorBean> movieActor) {
